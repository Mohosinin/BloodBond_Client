...
import { FaEdit, FaTrash, FaEye, FaTasks, FaUser, FaClock, FaCheck, FaTimes } from 'react-icons/fa';
        ...
        <div className="w-full max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Manage all donation requests in the system.</p>
                </div>
                                    ...
                                    <td className="text-left">
                                        <div className="flex justify-start items-center gap-2">
                                            ...
                                            <button 
                                                ...
                                                className="btn btn-sm btn-circle btn-ghost text-gray-500 tooltip p-2" 
                                            ...
                                            {isAdmin && (
                                                <>
                                                    <Link to={`/dashboard/update-donation-request/${req._id}`} state={{ from: location.pathname }} className="btn btn-sm btn-circle btn-ghost text-blue-500 tooltip p-2" data-tip="Edit">
                                                        <FaEdit />
                                                    </Link>
                                                    <button onClick={() => handleDelete(req._id)} className="btn btn-sm btn-circle btn-ghost text-red-500 tooltip p-2" data-tip="Delete">
                                                        <FaTrash />
                                                    </button>
                                                </>
                                            )}
                                            
                                             <Link to={`/dashboard/donation-request-details/${req._id}`} className="btn btn-sm btn-circle btn-ghost text-gray-500 tooltip p-2" data-tip="View Details">
                                                <FaEye />
                                             </Link>
                                        </div>
                                    </td>
