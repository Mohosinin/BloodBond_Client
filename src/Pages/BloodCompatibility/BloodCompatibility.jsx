...
const BloodCompatibility = () => {
    ...
    const containerClass = isDark
        ? 'min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-16 px-4'
        : 'min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 py-16 px-4';
